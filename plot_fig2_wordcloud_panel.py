...
STOPWORDS = {
    ...
    'like', 'which', 'image', 'picture', 'figure',
}
...
wc_125.recolor(color_func=make_freq_color_func(freq_125, "#c6dbef", "#08519c"))

wc_75 = WordCloud(**wc_kwargs).generate_from_frequencies(freq_75)
wc_75.recolor(color_func=make_freq_color_func(freq_75, "#fcbba1", "#7f1b1b"))
